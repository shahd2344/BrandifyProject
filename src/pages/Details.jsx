...
/>
            ...
            <p className="course-meta">Sarah Johnson • ⭐ 4.9 • 8 weeks</p>

            <h4 className="price">${course?.price || 299}</h4>

            <h4>Course Description</h4>
            <p className="details-desc">{course?.desc}</p>
          </div>
          ...
          <div className="details-sidebar">
            <div className="schedule-card">
              ...
              <p className="bold">Monday, Jan 15 • 2:00 PM - 4:00 PM</p>

              <button className="btn-outline full">Add to Calendar</button>

              <p className="hint">⏰ Reminder will be sent 24h before course</p>
            </div>
